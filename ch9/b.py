...
# You can use methods like this to control how users of your
...
# takes extreme attention to detail in addition to basic checks like those shown here.
...
print("Add 100 miles to the odometer reading.")
